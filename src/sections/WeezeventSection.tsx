...
const COPY_I18N: Record<Lang, {
  ...
  fr: {
    kicker: 'BILLETTERIE',
    headPre: 'PRENDS TON ', headAccent: 'PASS',
    subtitle: 'Places limitées. Rejoins plus de 400 danseurs venus de 20+ pays pour quatre jours inoubliables à Fribourg.',
    included: ['Accès complet au festival', '3 soirées épiques', 'Sociales et soirées', '7 bootcamps intensifs', 'Workshops avant-soirée'],
    trustSecure: 'Paiement sécurisé', trustTicket: 'E-billet immédiat',
    ticketHeader: 'Billetterie officielle',
